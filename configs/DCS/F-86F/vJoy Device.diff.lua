local diff = {
	...
	["keyDiffs"] = {
		["d100pnilu1627cdnilvdnilvpnilvunil"] = {
			["name"] = "A-4 Visier Radarzielauswahlknopf",
			["removed"] = {
				[1] = {
					["key"] = "JOY_BTN3",
				},
		...
		["d439pnilu440cdnilvdnilvpnilvunil"] = {
			["name"] = "A-4 Visier, elektrische Arretierung (am Gasgriff)",
			["removed"] = {
				[1] = {
					["key"] = "JOY_BTN4",
				},
		...
		["d84pnilu85cdnilvdnilvpnilvunil"] = {
			["name"] = "Abzug - ZWEITE STUFE (Geschütz feuert)",
			["removed"] = {
				[1] = {
					["key"] = "JOY_BTN1",
				},
